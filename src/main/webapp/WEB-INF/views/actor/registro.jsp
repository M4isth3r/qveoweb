            ...
            <body>
                ...
                <main>
                    <div class="row">
                        ...
                        <form:form method="POST" action="${action}" modelAttribute="actorNuevo" enctype="multipart/form-data" class="col s12 white-text">
                                ...
                                <div class="col s8">
                                    ...
                                    <c:if test="${editar == true}">
                                        <div class="col s4">
                                            ...
                                            <img alt="${actorNuevo.nombre}" src="${pageContext.request.contextPath}${actorNuevo.foto}" width="80%">
                                        </div>
                                    </c:if>
                                </div>
                                <div class="col s2"></div>
