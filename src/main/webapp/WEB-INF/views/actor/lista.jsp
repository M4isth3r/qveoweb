                ...
                <div class="container">
                    ...
                    <c:forEach items="${actores}" var="actor">
                        <div id="${actor.id}" class="row cuerpo">
                            <div class="col s3">
                                <img src="${pageContext.request.contextPath}${actor.foto}" alt="${actor.nombre}" width="40%">
                            </div>
                            <div class="col s3">${actor.nombre}</div>
                            <div id="${actor.id}" class="col s3">

                                <div class="col s12 m3 l4">
                                    <a href="/qveo/actor/edit/${actor.id}" class="btn-floating btn-large"><i
								class="material-icons editar">edit</i></a>
                                </div>
                                <div class="col s12 m6 l4">
                                    <a href="#modal2-actor-${actor.id}" class="btn-floating btn-large red modal-trigger"><i
                    ...
                    <c:forEach items="${actores}" var="actor">
                        ...
                        <div id="modal2-actor-${actor.id}" class="modal confirmar">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="/qveo/actor/delete/${actor.id}" class="waves-effect waves-green btn-flat modal-close eliminar-usuario">Aceptar</a>
                            </div>
                        </div>
