                    ...
                    <main>
                        <section>
                            <div class="row">
                                ...
                                <form:form method="POST" action="${action}" modelAttribute="serieNueva" enctype="multipart/form-data" class="col s12">
                                    <div class="row">
                                                    ...
                                                    <c:forEach items="${generos}" var="genero">
                                                        <c:if test="${fn:contains(serieNueva.generos,genero)}">
                                                            <form:label for="${genero.nombre}" path="generos">
                                                                <form:checkbox id="${genero.nombre}" path="generos" value="${genero.id}" checked="checked" />
                                                    ...
                                                    <c:forEach items="${directores}" var="director">
                                                        <c:if test="${fn:contains(serieNueva.directores,director)}">
                                                            <form:label for="${director.nombre}" path="directores">
                                                                <form:checkbox id="${director.nombre}" path="directores" value="${director.id}" checked="checked" />
                                                                <span>${director.nombre}</span>
                                                            </form:label>
                                                        </c:if>
                                                        <c:if test="${not(fn:contains(serieNueva.directores,director))}">
                                                            <form:label for="${director.nombre}" path="directores">
                                                                <form:checkbox id="${director.nombre}" path="directores" value="${director.id}" />
                                                                <span>${director.nombre}</span>
                                                            </form:label>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <c:forEach items="${plataformas}" var="plataforma">
                                                        <c:if test="${fn:contains(serieNueva.plataformas,plataforma)}">
                                                            ...
                                                            <form:label for="${plataforma.nombre}" path="plataformas">
                                                                <form:checkbox id="${plataforma.nombre}" path="plataformas" value="${plataforma.id}" checked="checked" />
                                                        ...
                                                        <c:if test="${not(fn:contains(serieNueva.plataformas,plataforma))}">
                                                            ...
                                                            <form:label for="${plataforma.nombre}" path="plataformas">
                                                                <form:checkbox id="${plataforma.nombre}" path="plataformas" value="${plataforma.id}" />
                                                                <span>${plataforma.nombre}</span>
                                                            </form:label>
                                                        </c:if>
                                                    </c:forEach>
