    ...
    <nav>
        <div class="nav-wrapper">
            <a href="#" class="sidenav-trigger" data-target="slide-out"><i
				class="material-icons">menu</i></a> <a href="${pageContext.request.contextPath}/home" class="title-qveo">QVEO</a>
            <ul class="right hide-on-med-and-down">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/usuario"><img class="circle icon-user" src="${pageContext.request.contextPath}/resources/img/iconouser.jpg"></a>
                </li>
            </ul>
        </div>
    </nav>
...
<ul id="slide-out" class="sidenav">
    <div>
        <a href="#"><img class="circle icon-user icon-user-sidenav" src="${pageContext.request.contextPath}/resources/img/iconouser.jpg"></a>
    </div>
